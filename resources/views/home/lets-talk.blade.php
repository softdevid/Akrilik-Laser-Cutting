            ...
            <div class="row">
                <div class="col-12">
                    <article>
                                    ...
                                    <div class="col-lg-5 stack1" style="padding-left: 15px; padding-right: 15px;">
                                        ...
                                        <div class="card border-0 mb-3" style="max-width: 540px;">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-8 text-md-start text-center">
                                                    <div class="card-body">
                                                        <h5 class="card-title">Kalikabong, Kec. Kalimanah, Kab. Purbalingga</h5>
                                        ...
                                        <div class="p-md-5 p-3 form-talk" style="background-color: #f8f8f8;border-color: #dddddd;border-style: solid;border-width: 1px;border-radius: 2px;">                                            
                                            <form method="POST" action="/talk/send-mail/" enctype="multipart/form-data" class="needs-validation" novalidate>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="email" name="email" class="form-control form-control-lg" id="talk-email" required>
                                                    <div class="invalid-feedback">
                                                        Isikan email
                                                    </div>
                                                </div>
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" name="subjek" class="form-control form-control-lg" id="talk-subject" required>
                                                    <div class="invalid-feedback">
                                                        Isikan subjek
                                                    </div>
                                                </div>
                        ...
                        <div class="reach-us">
                            <h2 class="judul-lokasi" style="font-weight: bold;margin-bottom: 20px;">Lokasi terdekat kami</h2>
