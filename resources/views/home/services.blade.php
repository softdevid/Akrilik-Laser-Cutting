                    ...
                    <div class="col" data-aos="fade-down" data-aos-duration="1000">
                        <div class="h-100 border-0">
                            ...
                            <div class="card-body mt-3">
                                ...
                                <a href="/services/{{$services->slug}}" class="btn btn-dark" id="button">Learn More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="col" data-aos="fade-down" data-aos-duration="1000">
                        <div class="h-100 border-0">
                            ...
                            <div class="card-body mt-3">
                                ...
                                {{-- <a href="/services/{{ route('/services/', $services->slug)}}" class="btn btn-dark" id="button">Learn More</a> --}}
                            </div>
                        </div>
                    </div>
                    @endforeach
